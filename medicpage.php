...
$count=0;
    ...
    if(isset($_POST['submit']))
   {
    ...
    $query="SELECT name,phone,email FROM assistance where area='$area' and role='medical help'";
...
<head>
    ...
    <p class="head-text">information of available medics in your locality!!</p>
