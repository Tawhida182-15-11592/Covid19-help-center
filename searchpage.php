...
$count=0;
    ...
    if(isset($_POST['submit']))
   {
    ...
    $query="SELECT name,phone,email FROM assistance where area='$area' and role='volunteer'";
...
<head>
    ...
    <p class="head-text">information of available assistants in your locality!!</p>
...
<div class="container bg-light pd-5 my-3">
    <div class="col-sm-6">
